...
public class Prog340 extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		//the following two lines of code was moved from case 0 of the below switch statement.
		g = new Graph();
		readGraphInfo(g);
		
		switch (actionIndex) {
		//This block of code needs to called before the chosen deliverable class is called.
//		case 0:
//			g = new Graph();
//			readGraphInfo(g);
//			break;
